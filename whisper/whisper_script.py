...
def process_folder(input_folder, output_base_dir, segment_time="00:20:00", language="vi", model="large", device="cuda"):
    ...
    for mp3_file in mp3_files:
        ...
        transcriptions_dir = os.path.join(
            output_base_dir, mp3_name, "transcriptions")
        ...
        try:
            ...
            for chunk_file in chunk_files:
                transcribe_chunk(chunk_file, transcriptions_dir,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="MP3 to Whisper Transcription Pipeline")
    parser.add_argument(
        "input_folder", help="Folder containing MP3 files to process")
    parser.add_argument("--output-dir", default="output",
                        help="Base output directory (default: output)")
    parser.add_argument("--segment-time", default="00:20:00",
                        help="Duration of each chunk (default: 00:20:00)")
