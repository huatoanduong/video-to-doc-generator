...
def main():
    ...
    print(
        f"  Histogram threshold: {high_sensitivity_detector.histogram_threshold}")
    ...
    print(
        f"  Detection sensitivity: {loaded_data['detection_info']['sensitivity']}")
    print(
        f"  Detection date: {loaded_data['detection_info']['detection_date']}")
